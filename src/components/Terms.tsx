    ...
    return (
        <div className="min-h-screen bg-slate-50 py-10 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-slate-100">
                <h1 className="text-2xl font-bold text-slate-800 mb-6">Syarat & Ketentuan KasCuan</h1>
                ...
                <div className="space-y-6 text-slate-600 text-sm leading-relaxed">
                    <section>
                        ...
                        <p>
                            KasCuan adalah platform perangkat lunak sebagai layanan (SaaS) yang dirancang untuk membantu Usaha Mikro, Kecil, dan Menengah (UMKM) dalam mengelola data operasional dan profil bisnis mereka.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            Platform ini disediakan "sebagaimana adanya". Kami tidak bertanggung jawab atas kerugian finansial, kehilangan data, atau kesalahan input yang dilakukan oleh pengguna selama menggunakan aplikasi KasCuan.
                        </p>
                    </section>
                </div>
            </div>
